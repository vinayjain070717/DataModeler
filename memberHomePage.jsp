...
Create Project
        ...
        <li class="nav-item active">
<button class="btn btn-link btn-lg text-white" data-toggle="modal" data-target="#openProjectModal">
Open Project
</button>
        </li>
        <li class="nav-item active">
...
Edit Profile
        ...
        <li class="nav-item active">
<button class="btn btn-link btn-lg text-white" data-toggle="modal" data-target="#logoutModal">
Logout
</button>
</li>
...
<input type='text' id='projectName' name='argument-1' placeholder='Name of Project' required='required' class='form-control' value=" ">
